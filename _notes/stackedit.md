...
Markdown is a great format for taking notes. You get all the formatting you might need to give your notes structure. Markdown has long been the standard format for code documentation. Now, with the rise JamStack, it is rapidly becoming the format of choice for writing all web content. In my case I wanted to be able to turn notes into blog posts on my VuePress site.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1NjU5MDU2OCwtMjA0NDczMzIyXX0=
-->